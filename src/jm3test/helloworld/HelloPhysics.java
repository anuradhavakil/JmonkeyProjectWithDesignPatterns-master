...
import RobotVoice.robot.me.MagentaGumball;
import RobotVoice.robot.me.BlueGumball;
import RobotVoice.robot.me.GreenGumball;
import RobotVoice.robot.me.YellowGumball;
import RobotVoice.robot.me.StartSpeak;
import RobotVoice.robot.me.WhiteGumball;
import RobotVoice.robot.me.Speak;
import Display.score.me.G;
import Display.score.me.Nohit;
import Display.score.me.M;
import Display.score.me.Balls;
import Display.score.me.W;
import Display.score.me.Y;
import Display.score.me.B;
...
public class HelloPhysics extends SimpleApplication implements PhysicsCollisionListener, GameSubject {
    ...
    public void displayGumball() {
        ...
        for (int g = 0; g < gumball_count; g++) {
            ...
            pic.setPosition(settings.getWidth() / 4 + g * 100, settings.getHeight() / 12);
...
//        makeBrick(vt);
    ...
    public void makeCannonBall() {
        ...
        //Random number generated in order to pick color of cannon ball randomly
